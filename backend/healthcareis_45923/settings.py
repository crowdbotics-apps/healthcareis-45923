"""
Django settings for healthcareis_45923 project.
...
ROOT_URLCONF = 'healthcareis_45923.urls'
...
WSGI_APPLICATION = 'healthcareis_45923.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthcareis_45923 API",
    "DESCRIPTION": "API documentation for healthcareis_45923 App",
    "VERSION": "v1",
}
